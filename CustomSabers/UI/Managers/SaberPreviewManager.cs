...
internal class SaberPreviewManager(LiteSaberSet saberSet, CSLConfig config, ColorSchemesSettings colorSchemesSettings)
{
    private readonly LiteSaberSet saberSet = saberSet;
    private readonly CSLConfig config = config;
    private readonly ColorSchemesSettings colorSchemesSettings = colorSchemesSettings;
